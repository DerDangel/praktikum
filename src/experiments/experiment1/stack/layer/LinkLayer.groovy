...
//            // Ist es eine eigene MAC-Adresse oder ein MAC-Broadcast ?
            if (macFrame.dstMacAddr == broadcastMacAddress ||
                    macFrame.dstMacAddr == macAddress) {
//                // Ja
...
//                        // ARP-PDU behandeln:
                        ...
                        switch (ar_pdu.operation) {
                            case ARP_REPLY:
                                ...
                                if (waitARP && (ownIpAddrs[cl_idu.lpName] == ar_pdu.targetProtoAddr)) {
                                    waitARP = false
    ...
    void send() {
        ...
        while (run) {
            ...
            I_PDU i_pdu = il_idu.sdu as I_PDU
          ...
          //  macFrame.dstMacAddr = arpTable[i_pdu.dstIpAddr]
            ...
            if (!macFrame.dstMacAddr) {
                ...
                println("Updating arp Table...")
                println("New record was added: " + i_pdu.dstIpAddr + ":" + nextMacAddr)
